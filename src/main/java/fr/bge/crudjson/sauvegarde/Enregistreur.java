...
public class Enregistreur {
	...
	public void enregistrer(Vetement vetement) throws Exception {
		...
		//mapper.writeValue(new File("c:\\file.json"), vetement);
		mapper.writeValue(fichierJson, vetement);//Fichier json remplace "c:\\file.json
	...
	public List < Vetement> lireTous() throws Exception {
		...
		//On les fichiers .json et on les convertit en java
